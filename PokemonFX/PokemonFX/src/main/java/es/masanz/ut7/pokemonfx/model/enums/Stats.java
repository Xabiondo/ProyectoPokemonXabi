...
public enum Stats {
    ...
    CUBONE("104", 50, 50, 95, 35, 40, 50, 64),
    MAROWAK("105", 60, 80, 110, 45, 50, 80, 124),
    DEWGONG("087", 90, 70, 80, 70, 70, 95, 166),
    DIGLETT("050", 10, 55, 25, 95, 35, 45, 53),
    DUGTRIO("051", 35, 100, 50, 120, 50, 70, 142),
    DITTO("132", 48, 48, 48, 48, 48, 48, 101),
    DODUO("084", 35, 85, 45, 75, 35, 35, 62),
    DODRIO("085", 60, 110, 70, 110, 60, 60, 165),
